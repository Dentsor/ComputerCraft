-- Welcome to PoDS, the Power on Delivery System, developed by Dentsor and Popill in August of 2019
...
local pods_beta_channel = 71
local pods_beta_pastecode = "3QUcUV8s"
local pods_beta_labelDefault = "podsBeta_noname%i"
...
local pods_config = {
	...
	broadcast_channel = pods_beta_channel, -- PoDS broadcast channel
	...
	label_default = pods_beta_labelDefault, -- Default label of new Pods
}
...
local programVersion = "v1.2 BETA"
local programName = string.format("Power on Delivery System %s", programVersion)
local pods_static = {
	pastecode = pods_beta_pastecode, -- Pastebin code for updates
